    ...
    <div class="row" style="margin-top: 5rem !important;">
        <div class="col">
            <section>
                ...
                <p>Welcome to YTMP4 | YTMP3!</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use YTMP4 |
                    YTMP3 if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>We employ the use of cookies. By accessing YTMP4 | YTMP3, you agreed to use cookies in agreement with the
                    YTMP4 | YTMP3's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, YTMP4 | YTMP3 and/or its licensors own the intellectual property rights for all
                    material on YTMP4 | YTMP3. All intellectual property rights are reserved. You may access this from YTMP4
                    | YTMP3 for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from YTMP4 | YTMP3</li>
                    <li>Sell, rent or sub-license material from YTMP4 | YTMP3</li>
                    <li>Reproduce, duplicate or copy material from YTMP4 | YTMP3</li>
                    <li>Redistribute content from YTMP4 | YTMP3</li>
                </ul>

                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. YTMP4 | YTMP3 does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of YTMP4 | YTMP3,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, YTMP4 | YTMP3 shall not be liable for the Comments
                ...
                <p>YTMP4 | YTMP3 reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant YTMP4 | YTMP3 a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                    ...
                    absence of YTMP4 | YTMP3; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to YTMP4 | YTMP3. Please include your name, your
                ...
                <p>No use of YTMP4 | YTMP3's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
